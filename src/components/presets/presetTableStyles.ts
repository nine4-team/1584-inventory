export const presetsTableStyles = {
  wrapper: 'relative overflow-visible bg-white shadow ring-1 ring-black ring-opacity-5 rounded-md max-w-4xl',
...
export const presetsActionMenuStyles = {
  ...
  panel:
    'absolute right-0 top-full mt-2 w-32 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 z-50',
  portalPanel:
    'fixed w-32 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 z-50',
